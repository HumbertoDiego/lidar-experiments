...
In this scenario you can acces the data also using the [getSerialData.py](#section-311) program. Just change the port from `/dev/ttyAMA0` to  `COM7` or the corresponding port. 
