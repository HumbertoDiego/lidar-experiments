...
Check the name of the device as described in [Check LiDAR USB port](#section-20). In our case `\dev\ttyAMA0`. And a programa like this (`getSerialData.py`) could access the distance and angles:
