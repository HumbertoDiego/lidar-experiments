...
The [my_robot.launch](https://github.com/HumbertoDiego/lidar-experiments/blob/main/scripts/my_robot.launch), [my_robot.lua](https://github.com/HumbertoDiego/lidar-experiments/blob/main/scripts/my_robot.lua) and the [my_robot.bag](https://github.com/HumbertoDiego/lidar-experiments/blob/main/sample_data/min.bag) are available to download. Run cartographer_ros with:
...
<!-- 
git add * ; git commit -m "update lidar lidar imu files"; git push -u origin main
 -->